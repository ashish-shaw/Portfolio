  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          This website is a clone of UpGrad an Online learning platform. In this website
          you can give the details of the courses that you want to study and then you can insure your course
          after filling up the user's details and payment.
        </p>
        ...
        <div className={style.btndivv}>
          ...
          >
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://clone-upgrad.herokuapp.com/"
            >
              <span>
                <svg
                  style={{
