...
import img1 from "./plum1.png";
import img2 from "./plum2.png";
import img3 from "./plum3.png";
import img4 from "./plum4.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          This website is a clone of Plumgoodness where we can buy cosmetics
          online. You can add the items in carts then buy the products
          by checking out. And after the payment is done your order is finally placed. 
        </p>
        ...
        <div className={style.btndivv}>
          ...
          >
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://plumgoodnessclone.netlify.app"
            >
              <span>
                <svg
                  style={{
