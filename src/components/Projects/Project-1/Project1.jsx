...
import img1 from "./Nykaa-1.png";
import img2 from "./Nykaa-2.png";
import img3 from "./Nykaa-3.png";
import img4 from "./Nykaa-4.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
        Nykaa is an E-commerce website where we can buy cosmetics
          online. You can add the items in carts then buy the products
          by checking out. And after the payment is done your order is placed.
        </p>
        ...
        <div className={style.btndivv}>
          ...
          >
            <a
              href="https://nykaa-clone-ashish.netlify.app"
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
            >
              <span>
